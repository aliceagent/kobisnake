# Sprint 19 — Single Player (post-1.0)

**Lead:** Sonnet (Fable designs first) · **Agents:** Fable ×1, Opus ×0.5, Sonnet ×2, Sonnet-QA ×1 · **Prerequisite:** `sprint-18-done`
...
## Design (Fable, ticket KS-19-01 finalises)
...
## Tickets
### KS-19-01 · Single-player design lock
...
### KS-19-02 · Solo simulation mode
Owner: Opus · Size: M · Depends on: KS-19-01 · Files: `src/core/round.js`, `src/core/lasers.js`, `src/core/score.js`, `tests/unit/core/solo.test.js`
...
### KS-19-03 · Solo flow, HUD and game-over screen
Owner: Sonnet · Size: M · Depends on: KS-19-02 · Files: `src/game/gameStateMachine.js`, `src/game/session.js`, `src/ui/hud.js`, `src/ui/screens/soloSetup.js`, `src/ui/screens/gameOver.js`, `src/save/saveData.js` (highScores, schema v2 migration)
...
### KS-19-04 · Solo tests and statistics
Owner: Sonnet-QA · Size: M · Depends on: KS-19-02 · Files: `tests/sim/soloStats.test.js`, `tests/e2e/solo.spec.js`, `tests/visual/solo.visual.spec.js`
Acceptance criteria: [ ] AC1 survivorBot median survival meets the target on NORMAL; [ ] AC2 e2e and visuals green.

### KS-19-05 · Tutorial and docs update
Owner: Sonnet · Size: S · Depends on: KS-19-03 · Files: `src/modes/tutorial.js`, `docs/DEVELOPER-GUIDE.md`, `CHANGELOG.md`
...
## Exit criteria
- [ ] Fable signs; tag `sprint-19-done` and `v1.1.0`.
