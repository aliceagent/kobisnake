 ...
 * string the game renders, in one frozen object, keyed by screen and purpose. This module is the catalogue
 ...
 */
export const STRINGS = deepFreeze(STRINGS_UNFROZEN);
